...
namespace Tmm.Tests
{
  public class CustomersControllerTests : IDisposable
  {
    ...
    public async Task UpdateCustomer_ValidId_UpdatesCustomer()
    {
      ...
      // Detach all entities being tracked to ensure that the updated customer instance won't conflict
    ...
    [Fact]
    public async Task UpdateCustomer_InvalidId_ReturnsNotFoundResult()
    {
